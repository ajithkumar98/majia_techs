...
<h1 style="text-align: center;padding-bottom: 40PX">OTHERS</h1>
<?php
// define how many results you want per page
$results_per_page = 10;
// find out the number of results stored in database
$sql="SELECT * FROM blog where category='others'";
...
$sql="SELECT * FROM blog where category='others' LIMIT " . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($con, $sql);
...
for ($page=1;$page<=$number_of_pages;$page++) {
  echo '
	<span><a style="color: red;text-align: center" href="index.php?page=' . $page . '">' . $page . '</a>|
</span>
';
}
?>
