...
<h1 style="text-align: center;padding-bottom: 40px">MOBILES</h1>
<?php
// define how many results you want per page
$results_per_page = 10;
// find out the number of results stored in database
$sql="SELECT * FROM blog WHERE category='mobiles'";
...
$sql="SELECT * FROM blog where category='mobiles' LIMIT " . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($con, $sql);
...
for ($page=1;$page<=$number_of_pages;$page++) {
  echo '<div class="container" style="padding:20px;color: red;font-size:15px;text-align:center">
	<div><a style="color: red;text-align: center" href="mobile.php?page=' . $page . '">' . $page . '</a>| </div>
</div>
';
}
?>
